...
public class ChSystem : ChIntegrableIIorder {
  ...
  public virtual void AddMesh(SWIGTYPE_p_std__shared_ptrT_fea__ChMesh_t mesh) {
    corePINVOKE.ChSystem_AddMesh(swigCPtr, SWIGTYPE_p_std__shared_ptrT_fea__ChMesh_t.getCPtr(mesh));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public virtual void RemoveMesh(SWIGTYPE_p_std__shared_ptrT_fea__ChMesh_t mesh) {
    corePINVOKE.ChSystem_RemoveMesh(swigCPtr, SWIGTYPE_p_std__shared_ptrT_fea__ChMesh_t.getCPtr(mesh));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public SWIGTYPE_p_std__vectorT_std__shared_ptrT_fea__ChMesh_t_t Get_meshlist() {
    SWIGTYPE_p_std__vectorT_std__shared_ptrT_fea__ChMesh_t_t ret = new SWIGTYPE_p_std__vectorT_std__shared_ptrT_fea__ChMesh_t_t(corePINVOKE.ChSystem_Get_meshlist(swigCPtr), false);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public SWIGTYPE_p_std__shared_ptrT_fea__ChMesh_t SearchMesh(string name) {
    SWIGTYPE_p_std__shared_ptrT_fea__ChMesh_t ret = new SWIGTYPE_p_std__shared_ptrT_fea__ChMesh_t(corePINVOKE.ChSystem_SearchMesh(swigCPtr, name), true);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public virtual void SetCollisionSystem(SWIGTYPE_p_std__shared_ptrT_chrono__collision__ChCollisionSystem_t newcollsystem) {
    corePINVOKE.ChSystem_SetCollisionSystem(swigCPtr, SWIGTYPE_p_std__shared_ptrT_chrono__collision__ChCollisionSystem_t.getCPtr(newcollsystem));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
  }

  public SWIGTYPE_p_std__shared_ptrT_chrono__collision__ChCollisionSystem_t GetCollisionSystem() {
    SWIGTYPE_p_std__shared_ptrT_chrono__collision__ChCollisionSystem_t ret = new SWIGTYPE_p_std__shared_ptrT_chrono__collision__ChCollisionSystem_t(corePINVOKE.ChSystem_GetCollisionSystem(swigCPtr), true);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
