...
public class ChLoadCustomMultiple : ChLoadBase {
  ...
  public virtual ChVectorDynamicD GetQ() {
    ChVectorDynamicD ret = new ChVectorDynamicD((SwigDerivedClassHasMethod("GetQ", swigMethodTypes15) ? corePINVOKE.ChLoadCustomMultiple_GetQSwigExplicitChLoadCustomMultiple(swigCPtr) : corePINVOKE.ChLoadCustomMultiple_GetQ(swigCPtr)), false);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  private void SwigDirectorConnect() {
    ...
    if (SwigDerivedClassHasMethod("InjectKRMmatrices", swigMethodTypes13))
      swigDelegate13 = new SwigDelegateChLoadCustomMultiple_13(SwigDirectorMethodInjectKRMmatrices);
    if (SwigDerivedClassHasMethod("KRMmatricesLoad", swigMethodTypes14))
      swigDelegate14 = new SwigDelegateChLoadCustomMultiple_14(SwigDirectorMethodKRMmatricesLoad);
    if (SwigDerivedClassHasMethod("GetQ", swigMethodTypes15))
      swigDelegate15 = new SwigDelegateChLoadCustomMultiple_15(SwigDirectorMethodGetQ);
    corePINVOKE.ChLoadCustomMultiple_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8, swigDelegate9, swigDelegate10, swigDelegate11, swigDelegate12, swigDelegate13, swigDelegate14, swigDelegate15);
  }
  ...
  public delegate void SwigDelegateChLoadCustomMultiple_13(global::System.IntPtr mdescriptor);
  public delegate void SwigDelegateChLoadCustomMultiple_14(double Kfactor, double Rfactor, double Mfactor);
  public delegate global::System.IntPtr SwigDelegateChLoadCustomMultiple_15();
